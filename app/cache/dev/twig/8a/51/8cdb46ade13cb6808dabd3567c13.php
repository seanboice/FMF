...
class __TwigTemplate_8a518cdb46ade13cb6808dabd3567c13 extends Twig_Template
{
    protected $parent;
    ...
    ";
        ...
        if ($template instanceof Twig_Template) {
            $template->display(array_merge($context, array("link" => false, "text" => $this->getAttribute($this->getContext($context, 'collector'), "symfonyversion", array(), "any", false))));
        } else {
            echo $this->env->getExtension('templating')->getTemplating()->render($template, array_merge($context, array("link" => false, "text" => $this->getAttribute($this->getContext($context, 'collector'), "symfonyversion", array(), "any", false))));
        }
        // line 8
        echo "
    ";
...
";
    ...
    <table>
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getContext($context, 'collector'), "bundles", array(), "any", false));
        foreach ($context['_seq'] as $context['name'] => $context['path']) {
            ...
            <td>";
            // line 121
            echo twig_escape_filter($this->env, $this->getContext($context, 'path'), "html");
            echo "</td>
        </tr>
        ";
        }
