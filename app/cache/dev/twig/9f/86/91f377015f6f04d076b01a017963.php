...
class __TwigTemplate_9f8691f377015f6f04d076b01a017963 extends Twig_Template
{
...
<div class=\"sf-toolbarreset\"
    ...
    ";
        ...
        foreach ($context['_seq'] as $context['name'] => $context['template']) {
            // line 28
            echo "        ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, 'template'), "renderblock", array("toolbar", array("collector" => $this->getAttribute($this->getContext($context, 'profiler'), "get", array($this->getContext($context, 'name'), ), "method", false), "profiler_url" => $this->getContext($context, 'profiler_url'), "token" => $this->getAttribute($this->getContext($context, 'profiler'), "token", array(), "any", false), "name" => $this->getContext($context, 'name'), "verbose" => $this->getContext($context, 'verbose')), ), "method", false), "html");
            // line 35
            echo "
    ";
        }
